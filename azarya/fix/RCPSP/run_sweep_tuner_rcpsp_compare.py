...
from project_crashing_problem_new_compare import ProjectCrashingProblem
...
def run_sweep():
    ...
    for T in target_deadlines:
        ...
        if z_star == 0:
            ...
            tuning_report.append({"T": T, "status": "TRIVIAL", "z_star": 0, "trials": []})
            continue
        ...
        if best is None or best["num_solutions"] == 0:
            ...
            with open(out_dir / "summary.json", "w") as f:
                json.dump(summary, f, indent=2)
            sweep_results.append(summary)
            tuning_report.append({"T": T, "status": "NO_SOLUTION", "z_star": z_star, "trials": trial_log})
            continue
        ...
        sweep_results.append(summary)
        tuning_report.append({"T": T, "status": "OK", "z_star": z_star, "best_config_idx": best["config_idx"], "best_config_label": best["config_label"], "best_gap": gap, "trials": trial_log})
